...
/*		NBT.modify(INVALID_ITEM, nbt ->
	...
	public static double getFuelTimeInSecond(@NotNull Material type)
	{
		return switch (type)
		{
			...
			case BLACK_CARPET, BLUE_CARPET, BROWN_CARPET, CYAN_CARPET, GRAY_CARPET, GREEN_CARPET, LIGHT_BLUE_CARPET, LIGHT_GRAY_CARPET, LIME_CARPET, MAGENTA_CARPET,
					 ORANGE_CARPET, PINK_CARPET, PURPLE_CARPET, RED_CARPET, WHITE_CARPET, YELLOW_CARPET -> 3.35;
			case ACACIA_BUTTON, BIRCH_BUTTON, DARK_OAK_BUTTON, MANGROVE_BUTTON, JUNGLE_BUTTON, OAK_BUTTON, SPRUCE_BUTTON, CHERRY_BUTTON, BAMBOO_BUTTON, BOWL,
					 ACACIA_SAPLING, BIRCH_SAPLING, DARK_OAK_SAPLING, MANGROVE_PROPAGULE, JUNGLE_SAPLING, OAK_SAPLING, SPRUCE_SAPLING, CHERRY_SAPLING, STICK, BLACK_WOOL,
					 BLUE_WOOL, BROWN_WOOL, CYAN_WOOL, GRAY_WOOL, GREEN_WOOL, LIGHT_BLUE_WOOL, LIGHT_GRAY_WOOL, LIME_WOOL, MAGENTA_WOOL, ORANGE_WOOL, PINK_WOOL,
					 PURPLE_WOOL, RED_WOOL, WHITE_WOOL, YELLOW_WOOL, AZALEA, FLOWERING_AZALEA, LEAF_LITTER, SHORT_DRY_GRASS, TALL_DRY_GRASS, PALE_OAK_BUTTON -> 5;
			case ACACIA_SLAB, BIRCH_SLAB, DARK_OAK_SLAB, MANGROVE_SLAB, JUNGLE_SLAB, OAK_SLAB, SPRUCE_SLAB, CHERRY_SLAB, BAMBOO_SLAB, BAMBOO_MOSAIC_SLAB, PALE_OAK_SLAB -> 7.5;
			case ACACIA_DOOR, BIRCH_DOOR, DARK_OAK_DOOR, MANGROVE_DOOR, JUNGLE_DOOR, OAK_DOOR, SPRUCE_DOOR, CHERRY_DOOR, BAMBOO_DOOR, ACACIA_SIGN, BIRCH_SIGN,
					 DARK_OAK_SIGN, MANGROVE_SIGN, JUNGLE_SIGN, OAK_SIGN, SPRUCE_SIGN, CHERRY_SIGN, BAMBOO_SIGN, WOODEN_AXE, WOODEN_HOE, WOODEN_PICKAXE, WOODEN_SHOVEL,
					 WOODEN_SWORD, PALE_OAK_SIGN, ACACIA_HANGING_SIGN, BAMBOO_HANGING_SIGN, BIRCH_HANGING_SIGN, CHERRY_HANGING_SIGN, DARK_OAK_HANGING_SIGN, JUNGLE_HANGING_SIGN,
					 MANGROVE_HANGING_SIGN, OAK_HANGING_SIGN, PALE_OAK_HANGING_SIGN, SPRUCE_HANGING_SIGN, PALE_OAK_DOOR -> 10;
			case ACACIA_LOG, BIRCH_LOG, DARK_OAK_LOG, MANGROVE_LOG, JUNGLE_LOG, OAK_LOG, SPRUCE_LOG, CHERRY_LOG, STRIPPED_ACACIA_LOG, STRIPPED_BIRCH_LOG,
					 STRIPPED_DARK_OAK_LOG, STRIPPED_MANGROVE_LOG, STRIPPED_JUNGLE_LOG, STRIPPED_OAK_LOG, STRIPPED_SPRUCE_LOG, STRIPPED_CHERRY_LOG, ACACIA_WOOD,
					 BIRCH_WOOD, DARK_OAK_WOOD, MANGROVE_WOOD, JUNGLE_WOOD, OAK_WOOD, SPRUCE_WOOD, CHERRY_WOOD, STRIPPED_ACACIA_WOOD, STRIPPED_BIRCH_WOOD,
					 STRIPPED_DARK_OAK_WOOD, STRIPPED_MANGROVE_WOOD, STRIPPED_JUNGLE_WOOD, STRIPPED_OAK_WOOD, STRIPPED_SPRUCE_WOOD, STRIPPED_CHERRY_WOOD, ACACIA_PLANKS,
					 BIRCH_PLANKS, DARK_OAK_PLANKS, MANGROVE_PLANKS, JUNGLE_PLANKS, OAK_PLANKS, SPRUCE_PLANKS, CHERRY_PLANKS, BAMBOO_PLANKS, ACACIA_STAIRS, BIRCH_STAIRS,
					 DARK_OAK_STAIRS, MANGROVE_STAIRS, JUNGLE_STAIRS, OAK_STAIRS, SPRUCE_STAIRS, CHERRY_STAIRS, BAMBOO_STAIRS, ACACIA_PRESSURE_PLATE,
					 BIRCH_PRESSURE_PLATE, DARK_OAK_PRESSURE_PLATE, MANGROVE_PRESSURE_PLATE, JUNGLE_PRESSURE_PLATE, OAK_PRESSURE_PLATE, SPRUCE_PRESSURE_PLATE,
					 CHERRY_PRESSURE_PLATE, BAMBOO_PRESSURE_PLATE, ACACIA_TRAPDOOR, BIRCH_TRAPDOOR, DARK_OAK_TRAPDOOR, MANGROVE_TRAPDOOR, JUNGLE_TRAPDOOR, OAK_TRAPDOOR,
					 SPRUCE_TRAPDOOR, CHERRY_TRAPDOOR, BAMBOO_TRAPDOOR, ACACIA_FENCE_GATE, BIRCH_FENCE_GATE, DARK_OAK_FENCE_GATE, MANGROVE_FENCE_GATE, JUNGLE_FENCE_GATE,
					 OAK_FENCE_GATE, SPRUCE_FENCE_GATE, CHERRY_FENCE_GATE, BAMBOO_FENCE_GATE, ACACIA_FENCE, BIRCH_FENCE, DARK_OAK_FENCE, MANGROVE_FENCE, JUNGLE_FENCE,
					 OAK_FENCE, SPRUCE_FENCE, CHERRY_FENCE, BAMBOO_FENCE, BAMBOO_BLOCK, BAMBOO_MOSAIC, STRIPPED_BAMBOO_BLOCK, BEEHIVE, BEE_NEST, LADDER, CRAFTING_TABLE,
					 CARTOGRAPHY_TABLE, FLETCHING_TABLE, SMITHING_TABLE, LOOM, BOOKSHELF, LECTERN, COMPOSTER, CHEST, TRAPPED_CHEST, BARREL, DAYLIGHT_DETECTOR, JUKEBOX,
					 NOTE_BLOCK, BROWN_MUSHROOM_BLOCK, RED_MUSHROOM_BLOCK, MUSHROOM_STEM, MANGROVE_ROOTS, BLACK_BANNER, BLUE_BANNER, BROWN_BANNER, CYAN_BANNER,
					 GRAY_BANNER, GREEN_BANNER, LIGHT_BLUE_BANNER, LIGHT_GRAY_BANNER, LIME_BANNER, MAGENTA_BANNER, ORANGE_BANNER, PINK_BANNER, PURPLE_BANNER, RED_BANNER,
					 WHITE_BANNER, YELLOW_BANNER, CROSSBOW, BOW, FISHING_ROD, BAMBOO_MOSAIC_STAIRS, CHISELED_BOOKSHELF, PALE_OAK_LOG, PALE_OAK_PLANKS, STRIPPED_PALE_OAK_LOG,
					 STRIPPED_PALE_OAK_WOOD, PALE_OAK_STAIRS, PALE_OAK_PRESSURE_PLATE, PALE_OAK_TRAPDOOR, PALE_OAK_FENCE_GATE, PALE_OAK_FENCE -> 15;
			case ACACIA_BOAT, BIRCH_BOAT, DARK_OAK_BOAT, MANGROVE_BOAT, JUNGLE_BOAT, OAK_BOAT, SPRUCE_BOAT, CHERRY_BOAT, BAMBOO_RAFT, ACACIA_CHEST_BOAT,
					 BIRCH_CHEST_BOAT, DARK_OAK_CHEST_BOAT, MANGROVE_CHEST_BOAT, JUNGLE_CHEST_BOAT, OAK_CHEST_BOAT, SPRUCE_CHEST_BOAT, CHERRY_CHEST_BOAT,
					 BAMBOO_CHEST_RAFT, PALE_OAK_BOAT, PALE_OAK_CHEST_BOAT -> 60;
	...
	public static double getCompostChance(@NotNull Material type)
	{
		return switch (type)
		{
			case BEETROOT_SEEDS, DRIED_KELP, GLOW_BERRIES, SHORT_GRASS, HANGING_ROOTS, MANGROVE_ROOTS, KELP, ACACIA_LEAVES, AZALEA_LEAVES, BIRCH_LEAVES,
					 DARK_OAK_LEAVES, JUNGLE_LEAVES, MANGROVE_LEAVES, OAK_LEAVES, SPRUCE_LEAVES, MELON_SEEDS, MOSS_CARPET, PUMPKIN_SEEDS, ACACIA_SAPLING, BIRCH_SAPLING,
					 SPRUCE_SAPLING, DARK_OAK_SAPLING, JUNGLE_SAPLING, MANGROVE_PROPAGULE, OAK_SAPLING, SEAGRASS, TALL_SEAGRASS, SMALL_DRIPLEAF, SWEET_BERRIES,
					 WHEAT_SEEDS -> 30d;
			case CACTUS, DRIED_KELP_BLOCK, FLOWERING_AZALEA_LEAVES, GLOW_LICHEN, MELON_SLICE, NETHER_SPROUTS, SUGAR_CANE, TALL_GRASS, VINE, WEEPING_VINES,
					 TWISTING_VINES -> 50d;
			case APPLE, AZALEA, BEETROOT, BIG_DRIPLEAF, CARROT, COCOA_BEANS, FERN, LARGE_FERN, DANDELION, POPPY, BLUE_ORCHID, ALLIUM, AZURE_BLUET, RED_TULIP,
					 ORANGE_TULIP, WHITE_TULIP, PINK_TULIP, OXEYE_DAISY, CORNFLOWER, LILY_OF_THE_VALLEY, WITHER_ROSE, SUNFLOWER, LILAC, ROSE_BUSH, PEONY, LILY_PAD, MELON,
					 MOSS_BLOCK, BROWN_MUSHROOM, RED_MUSHROOM, MUSHROOM_STEM, NETHER_WART, POTATO, PUMPKIN, CARVED_PUMPKIN, SEA_PICKLE, SHROOMLIGHT, SPORE_BLOSSOM, WHEAT,
					 CRIMSON_FUNGUS, WARPED_FUNGUS, CRIMSON_ROOTS, WARPED_ROOTS -> 65d;
	...
	public static boolean isPickBlockable(@NotNull Material type)
	{
		return type.isBlock() || switch (type)
		{
			case POTATO, CARROT, COCOA_BEANS, WHEAT_SEEDS, NETHER_WART, MELON_SEEDS, PUMPKIN_SEEDS, REDSTONE, SWEET_BERRIES, ARMOR_STAND, ITEM_FRAME, PAINTING,
					 ...
					 POLAR_BEAR_SPAWN_EGG, PUFFERFISH_SPAWN_EGG, RABBIT_SPAWN_EGG, RAVAGER_SPAWN_EGG, SALMON_SPAWN_EGG, SHEEP_SPAWN_EGG, SHULKER_SPAWN_EGG,
					 SILVERFISH_SPAWN_EGG, SKELETON_HORSE_SPAWN_EGG, SKELETON_SPAWN_EGG, SLIME_SPAWN_EGG, SPIDER_SPAWN_EGG, SQUID_SPAWN_EGG, STRAY_SPAWN_EGG,
					 TRADER_LLAMA_SPAWN_EGG, TROPICAL_FISH_SPAWN_EGG, TURTLE_SPAWN_EGG, VEX_SPAWN_EGG, VILLAGER_SPAWN_EGG, VINDICATOR_SPAWN_EGG,
					 WANDERING_TRADER_SPAWN_EGG, WITCH_SPAWN_EGG, WITHER_SKELETON_SPAWN_EGG, WOLF_SPAWN_EGG, ZOMBIE_HORSE_SPAWN_EGG, ZOMBIFIED_PIGLIN_SPAWN_EGG,
					 ZOMBIE_SPAWN_EGG, ZOMBIE_VILLAGER_SPAWN_EGG, ACACIA_BOAT, BIRCH_BOAT, DARK_OAK_BOAT, JUNGLE_BOAT, OAK_BOAT, SPRUCE_BOAT, MINECART, CHEST_MINECART,
					 COMMAND_BLOCK_MINECART, FURNACE_MINECART, HOPPER_MINECART, TNT_MINECART, LEAD, END_CRYSTAL, STRING, HOGLIN_SPAWN_EGG, PIGLIN_SPAWN_EGG,
					 STRIDER_SPAWN_EGG, ZOGLIN_SPAWN_EGG, AXOLOTL_SPAWN_EGG, GLOW_SQUID_SPAWN_EGG, GOAT_SPAWN_EGG, PIGLIN_BRUTE_SPAWN_EGG, POWDER_SNOW_BUCKET,
