...
public enum CustomMaterial implements Translatable
{
	...
	YOUPEOPLEGAME_SACK_EXPANDER_COOKIE(Material.ORANGE_BUNDLE, "&6key:item.youpeoplegame.sack_expander_cookie|쿠키 주머니 확장", "주머니 확장"),
	YOUPEOPLEGAME_SACK_EXPANDER_CURRENCY(Material.PINK_BUNDLE, "&6key:item.youpeoplegame.sack_expander_currency|재화 주머니 확장", "주머니 확장"),
	YOUPEOPLEGAME_SACK_EXPANDER_DIRT(Material.BUNDLE, "&6key:item.youpeoplegame.sack_expander_dirt|흙 주머니 확장", "주머니 확장"),
	YOUPEOPLEGAME_SACK_EXPANDER_MINING(Material.GRAY_BUNDLE, "&6key:item.youpeoplegame.sack_expander_mining|광물 주머니 확장", "주머니 확장"),
	YOUPEOPLEGAME_SACK_EXPANDER_WOOD(Material.BROWN_BUNDLE, "&6key:item.youpeoplegame.sack_expander_wood|나무 주머니 확장", "주머니 확장"),
