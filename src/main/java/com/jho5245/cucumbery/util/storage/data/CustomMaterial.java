...
public enum CustomMaterial implements Translatable
{
	...
	YOUPEOPLEGAME_CRISPY_COOKIE_PICKAXE(Material.DIAMOND_PICKAXE,
			ComponentUtil.translate("&6key:item.youpeoplegame.crispy_cookie_pickaxe|바삭한 쿠키곡괭이").shadowColor(ShadowColor.shadowColor(-256)),
			Rarity.RARE, "바삭한 쿠키"),
	YOUPEOPLEGAME_CRISPY_COOKIE_AXE(Material.DIAMOND_AXE,
			ComponentUtil.translate("&6key:item.youpeoplegame.crispy_cookie_axe|바삭한 쿠키도끼").shadowColor(ShadowColor.shadowColor(-256)),
			Rarity.RARE, "바삭한 쿠키"),
	YOUPEOPLEGAME_CRISPY_COOKIE_SHOVEL(Material.DIAMOND_SHOVEL,
			ComponentUtil.translate("&6key:item.youpeoplegame.crispy_cookie_shovel|바삭한 쿠키삽").shadowColor(ShadowColor.shadowColor(-256)),
			Rarity.RARE, "바삭한 쿠키"),
	...
	YOUPEOPLEGAME_DAMP_COOKIE_POTION(Material.DEBUG_STICK, "&6key:item.youpeoplegame.damp_cookie_potion|눅눅한 쿠키 포션", "포션"),
	YOUPEOPLEGAME_GENERATOR_MATERIAL(Material.REDSTONE_TORCH, "&4key:item.youpeoplegame.generator_material|발전물체", "레드스톤"),
	YOUPEOPLEGAME_GOLD_PILE(Material.RAW_GOLD_BLOCK, "&ekey:item.youpeoplegame.gold_pile|금뭉치", "금"),
	YOUPEOPLEGAME_HARD_STONE(Material.STONE, "&7key:item.youpeoplegame.hard_stone|단단한 돌", "돌"),
	YOUPEOPLEGAME_IRON_PILE(Material.RAW_IRON_BLOCK, "&fkey:item.youpeoplegame.iron_pile|철뭉치", "철"),
	...
	YOUPEOPLEGAME_REFINED_QUARTZ(Material.WHITE_STAINED_GLASS, "&fkey:item.youpeoplegame.refined_quartz|가공된 석영", "석영"),
