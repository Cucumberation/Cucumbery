...
public enum CustomMaterial implements Translatable
{
	...
	DIAMOND_BLOCK_DECORATIVE(Material.DIAMOND_BLOCK, "key:item.cucumbery.diamond_block_decorative|장식용 다이아몬드 블록", Rarity.NORMAL,
	...
	NETHERITE_BLOCK_DECORATIVE(Material.NETHERITE_BLOCK, "key:item.cucumbery.netherite_block_decorative|장식용 네더라이트 블록", Rarity.NORMAL,
			CreativeCategory.BUILDING_BLOCKS),
	NETHERITE_CHESTPLATE_WITH_ELYTRA(Material.ELYTRA, "key:item.cucumbery.netherite_chestplate_with_elytra|네더라이트 겉날개", Rarity.EXCELLENT,
			CreativeCategory.TOOLS),
	...
	REDSTONE_BLOCK_INSTA_BREAK(Material.REDSTONE_BLOCK, "key:block.cucumbery.redstone_block_insta_break|즉시 부서지는 레드스톤 블록", Rarity.RARE,
	...
	SMOOTH_QUARTZ_SLAB_VERTICAL(Material.SMOOTH_QUARTZ_SLAB, "key:block.cucumbery.smooth_quartz_slab_vertical|매끄러운 석영 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
