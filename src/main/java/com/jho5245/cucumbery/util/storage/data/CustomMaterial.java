...
public enum CustomMaterial implements Translatable
{
	...
	TEST_PICKAXE(true, Material.IRON_PICKAXE, "key:item.cucumbery.test_pickaxe|테스트 곡괭이", Rarity._ADMIN, CreativeCategory.TOOLS),
	...
	WNYNYA_ORE(true, Material.PLAYER_HEAD, "rgb200,100,255;key:block.cucumbery.wnynya_ore|완YEE 광석", Rarity.RARE, "itemGroup.natural"),

	YOUPEOPLEGAME_BURNING_FIRE(Material.CAMPFIRE, "&6key:item.youpeoplegame.burning_fire|타오르는 불", Material.FIRE.translationKey()),
	YOUPEOPLEGAME_CHAOS_MATTER(Material.WARPED_HYPHAE, "&1key:item.youpeoplegame.chaos_matter|혼돈물질", "혼돈"),
	YOUPEOPLEGAME_CLAY_PILE(Material.TERRACOTTA, "&7key:item.youpeoplegame.clay_pile|뭉친 점토", "점토"),
	YOUPEOPLEGAME_COPPER_PILE(Material.RAW_COPPER_BLOCK, "#9b563e;key:item.youpeoplegame.copper_pile|구리뭉치", "구리"),
	YOUPEOPLEGAME_CORRUPTED_MATTER(Material.CRIMSON_HYPHAE, "&4key:item.youpeoplegame.corrupted_matter|오염물질", "오염"),
	YOUPEOPLEGAME_CRISPY_COOKIE(Material.COOKIE, "&6key:item.youpeoplegame.crispy_cookie|바삭한 쿠키", "key:itemGroup.crispyCookie|바삭한 쿠키"),
	YOUPEOPLEGAME_CRISPY_COOKIE_AXE(true, Material.DIAMOND_AXE,
	...
	YOUPEOPLEGAME_CRISPY_COOKIE_BOX(Material.ORANGE_SHULKER_BOX, "&6key:item.youpeoplegame.crispy_cookie_box|바삭한 쿠키박스", "key:itemGroup.crispyCookie|바삭한 쿠키"),
	YOUPEOPLEGAME_CRISPY_COOKIE_PICKAXE(true, Material.DIAMOND_PICKAXE,
			...
			"key:itemGroup.crispyCookie|바삭한 쿠키"),
	YOUPEOPLEGAME_CRISPY_COOKIE_SHOVEL(true, Material.DIAMOND_SHOVEL,
			...
			"key:itemGroup.crispyCookie|바삭한 쿠키"),
	YOUPEOPLEGAME_CRISPY_COOKIE_SWORD(true, Material.DIAMOND_SWORD,
			ComponentUtil.translate("&6key:item.youpeoplegame.crispy_cookie_shovel|바삭한 쿠키검").shadowColor(ShadowColor.shadowColor(-256)), Rarity.RARE,
			"key:itemGroup.crispyCookie|바삭한 쿠키"),
	YOUPEOPLEGAME_DAMP_COOKIE(Material.COOKIE, "&6key:item.youpeoplegame.damp_cookie|눅눅한 쿠키", Rarity.JUNK, "key:itemGroup.dampCookie|눅눅한 쿠키"),
	YOUPEOPLEGAME_DAMP_COOKIE_EVEN(Material.COOKIE, "&6&lkey:item.youpeoplegame.damp_cookie_even|더욱 눅눅한 쿠키", "key:itemGroup.dampCookie|눅눅한 쿠키"),
	YOUPEOPLEGAME_DAMP_COOKIE_PILE(Material.COOKIE, "&6&lkey:item.youpeoplegame.damp_cookie_pile|뭉친 눅눅한 쿠키", "key:itemGroup.dampCookie|눅눅한 쿠키"),
	YOUPEOPLEGAME_DAMP_COOKIE_POTION(Material.HONEY_BOTTLE, "&6key:item.youpeoplegame.damp_cookie_potion|눅눅한 쿠키 포션", "key:itemGroup.potion|포션"),
	YOUPEOPLEGAME_DIRT_PILE(Material.COARSE_DIRT, "#C3712C;key:item.youpeoplegame.dirt_pile|뭉친 흙", "흙"),
	YOUPEOPLEGAME_GENERATOR_MATERIAL(Material.REDSTONE_TORCH, "&4key:item.youpeoplegame.generator_material|발전물체", "전기"),
	YOUPEOPLEGAME_GOLD_PILE(Material.RAW_GOLD_BLOCK, "&ekey:item.youpeoplegame.gold_pile|금뭉치", "key:itemGroup.gold|금"),
	YOUPEOPLEGAME_GRAVEL_PILE(Material.DRIPSTONE_BLOCK, "&8key:item.youpeoplegame.gravel_pile|뭉친 자갈", "자갈"),
	...
	YOUPEOPLEGAME_MAGIC_MATTER(Material.LAPIS_LAZULI, "&1key:item.youpeoplegame.magic_matter|마력물질", "마나"),
	...
	YOUPEOPLEGAME_MOIST_COOKIE_BOOSTER(Material.HONEY_BOTTLE, "&6key:item.youpeoplegame.moist_cookie_booster|촉촉한 쿠키 촉진제", "포션"),
	YOUPEOPLEGAME_MOSS_PILE(Material.GREEN_GLAZED_TERRACOTTA, "&akey:item.youpeoplegame.moss_pile|뭉친 이끼", "이끼"),
	YOUPEOPLEGAME_MUD_PILE(Material.BLACKSTONE, "&0key:item.youpeoplegame.mud_pile|뭉친 진흙", "진흙"),
	YOUPEOPLEGAME_PALE_MOSS_PILE(Material.GRAY_GLAZED_TERRACOTTA, "&akey:item.youpeoplegame.pale_moss_pile|뭉친 창백한 이끼", "이끼"),
	YOUPEOPLEGAME_RED_SAND_PILE(Material.SMOOTH_RED_SANDSTONE, "&6key:item.youpeoplegame.red_sand_pile|뭉친 붉은모래", "모래"),
	...
	YOUPEOPLEGAME_REFINED_COPPER(Material.COPPER_BLOCK, "#9b563e;key:item.youpeoplegame.refined_copper|가공된 구리", "key:itemGroup.copper|구리"),
	YOUPEOPLEGAME_REFINED_DIAMOND(Material.DIAMOND_BLOCK, "&bkey:item.youpeoplegame.refined_diamond|가공된 다이아몬드", "key:itemGroup.diamond|다이아몬드"),
	YOUPEOPLEGAME_REFINED_EMERALD(Material.EMERALD_BLOCK, "&akey:item.youpeoplegame.refined_emerald|가공된 에메랄드", "key:itemGroup.emerald|에메랄드"),
	YOUPEOPLEGAME_REFINED_GOLD(Material.GOLD_BLOCK, "&ekey:item.youpeoplegame.refined_gold|가공된 금", "key:itemGroup.gold|금"),
	...
	YOUPEOPLEGAME_SACK_EXPANDER_COOKIE(Material.ORANGE_BUNDLE, "&6key:item.youpeoplegame.sack_expander_cookie|쿠키 주머니 확장", Rarity.RARE, "주머니 확장"),
	YOUPEOPLEGAME_SACK_EXPANDER_CURRENCY(Material.PINK_BUNDLE, "&6key:item.youpeoplegame.sack_expander_currency|재화 주머니 확장", Rarity.RARE, "주머니 확장"),
	YOUPEOPLEGAME_SACK_EXPANDER_DIRT(Material.BUNDLE, "&6key:item.youpeoplegame.sack_expander_dirt|흙 주머니 확장", Rarity.RARE, "주머니 확장"),
	YOUPEOPLEGAME_SACK_EXPANDER_MINING(Material.GRAY_BUNDLE, "&6key:item.youpeoplegame.sack_expander_mining|광물 주머니 확장", Rarity.RARE, "주머니 확장"),
	YOUPEOPLEGAME_SACK_EXPANDER_WOOD(Material.BROWN_BUNDLE, "&6key:item.youpeoplegame.sack_expander_wood|나무 주머니 확장", Rarity.RARE, "주머니 확장"),
	YOUPEOPLEGAME_SNOW_PILE(Material.CALCITE, "&fkey:item.youpeoplegame.snow_pile|뭉친 눈", "눈"),
	YOUPEOPLEGAME_SPIRIT_MATTER(Material.BAMBOO_MOSAIC,
			ComponentUtil.translate("&ekey:item.youpeoplegame.spirit_matter|정령물질").shadowColor(ShadowColor.fromHexString("#4BF010FF")), "혼돈"),
	YOUPEOPLEGAME_STARTER_AXE(true, Material.IRON_AXE, Material.IRON_AXE.translationKey(), "스타터"),
	YOUPEOPLEGAME_STARTER_PICKAXE(true, Material.IRON_PICKAXE, Material.IRON_PICKAXE.translationKey(), "스타터"),
	YOUPEOPLEGAME_STARTER_SHOVEL(true, Material.IRON_SHOVEL, Material.IRON_SHOVEL.translationKey(), "스타터"),
	YOUPEOPLEGAME_STARTER_SWORD(true, Material.IRON_SWORD, Material.IRON_SWORD.translationKey(), "스타터"),
	YOUPEOPLEGAME_SUPER_MOIST_COOKIE_BOOSTER(Material.HONEY_BOTTLE, "&6key:item.youpeoplegame.super_moist_cookie_booster|촉촉한 쿠키 포션", "포션"),
	;
