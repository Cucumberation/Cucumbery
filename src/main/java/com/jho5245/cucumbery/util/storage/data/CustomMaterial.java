...
public enum CustomMaterial implements Translatable
{
	...
	BRICK_THROWABLE(Material.SNOWBALL, "&ikey:item.cucumbery.brick_throwable|던질 수 있는 벽돌", Rarity.RARE, CreativeCategory.COMBAT),
	NETHER_BRICK_THROWABLE(Material.SNOWBALL, "&ikey:item.cucumbery.nether_brick_throwable|던질 수 있는 네더 벽돌", Rarity.RARE, CreativeCategory.COMBAT),
	COPPER_INGOT_THROWABLE(Material.SNOWBALL, "&ikey:item.cucumbery.copper_ingot_throwable|던질 수 있는 구리 주괴", Rarity.RARE, CreativeCategory.COMBAT),
	IRON_INGOT_THROWABLE(Material.SNOWBALL, "&ikey:item.cucumbery.iron_ingot_throwable|던질 수 있는 철 주괴", Rarity.RARE, CreativeCategory.COMBAT),
	GOLD_INGOT_THROWABLE(Material.SNOWBALL, "&ikey:item.cucumbery.gold_ingot_throwable|던질 수 있는 금 주괴", Rarity.RARE, CreativeCategory.COMBAT),
	NETHERITE_INGOT_THROWABLE(Material.SNOWBALL, "&ikey:item.cucumbery.netherite_ingot_throwable|던질 수 있는 네더라이트 주괴", Rarity.UNIQUE, CreativeCategory.COMBAT),
	...
	DIAMOND_BLOCK_DECORATIVE(Material.DIAMOND_BLOCK, "&ikey:item.cucumbery.diamond_block_decorative|장식용 다이아몬드 블록", Rarity.NORMAL,
	...
	ELYTRA_SHIVA_AMOODO_NAREUL_MAKEURLSOON_UPSOROAN(Material.ELYTRA, "&ikey:item.cucumbery.elytra_shiva_amoodo_nareul_makeurlsoon_upsoroan|시바 아무도 나를 막을 순 없겉날개",
	...
	I_WONT_LET_YOU_GO_BLOCK(Material.PLAYER_HEAD, "&ikey:block.cucumbery.i_wont_let_you_go_block|워어 아워 래 유 블록", Rarity.RARE,
	...
	NETHERITE_BLOCK_DECORATIVE(Material.NETHERITE_BLOCK, "&ikey:item.cucumbery.netherite_block_decorative|장식용 네더라이트 블록", Rarity.NORMAL,
			CreativeCategory.BUILDING_BLOCKS),
	NETHERITE_CHESTPLATE_WITH_ELYTRA(Material.ELYTRA, "&ikey:item.cucumbery.netherite_chestplate_with_elytra|네더라이트 겉날개", Rarity.EXCELLENT,
			CreativeCategory.TOOLS),
	...
	REDSTONE_BLOCK_INSTA_BREAK(Material.REDSTONE_BLOCK, "&ikey:block.cucumbery.redstone_block_insta_break|즉시 부서지는 레드스톤 블록", Rarity.RARE,
	...
	BAMBOO_MOSAIC_SLAB_VERTICAL(Material.BAMBOO_MOSAIC_SLAB, "&ikey:block.cucumbery.bamboo_mosaic_slab_vertical|대나무 모자이크 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	...
	MOSSY_COBBLESTONE_SLAB_VERTICAL(Material.MOSSY_COBBLESTONE_SLAB, "&ikey:block.cucumbery.mossy_cobblestone_slab_vertical|이끼 낀 조약돌 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	SMOOTH_STONE_SLAB_VERTICAL(Material.SMOOTH_STONE_SLAB, "&ikey:block.cucumbery.smooth_cobblestone_slab_vertical|매끄러운 돌 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	...
	MOSSY_STONE_BRICK_SLAB_VERTICAL(Material.MOSSY_STONE_BRICK_SLAB, "&ikey:block.cucumbery.mossy_stone_brick_slab_vertical|이끼 낀 석재 벽돌 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	...
	POLISHED_GRANITE_SLAB_VERTICAL(Material.POLISHED_GRANITE_SLAB, "&ikey:block.cucumbery.polished_granite_slab_vertical|윤나는 화강암 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	...
	POLISHED_DIORITE_SLAB_VERTICAL(Material.POLISHED_DIORITE_SLAB, "&ikey:block.cucumbery.polished_diorite_slab_vertical|윤나는 섬록암 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	...
	POLISHED_ANDESITE_SLAB_VERTICAL(Material.POLISHED_ANDESITE_SLAB, "&ikey:block.cucumbery.polished_andesite_slab_vertical|윤나는 안산암 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	COBBLED_DEEPSLATE_SLAB_VERTICAL(Material.COBBLED_DEEPSLATE_SLAB, "&ikey:block.cucumbery.cobbled_deepslate_slab_vertical|심층암 조약돌 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	POLISHED_DEEPSLATE_SLAB_VERTICAL(Material.POLISHED_DEEPSLATE_SLAB, "&ikey:block.cucumbery.polished_deepslate_slab_vertical|윤나는 심층암 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	DEEPSLATE_BRICK_SLAB_VERTICAL(Material.DEEPSLATE_BRICK_SLAB, "&ikey:block.cucumbery.deepslate_brick_slab_vertical|심층암 벽돌 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	DEEPSLATE_TILE_SLAB_VERTICAL(Material.DEEPSLATE_TILE_SLAB, "&ikey:block.cucumbery.deepslate_tile_slab_vertical|심층암 타일 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	...
	SMOOTH_SANDSTONE_SLAB_VERTICAL(Material.SMOOTH_SANDSTONE_SLAB, "&ikey:block.cucumbery.smooth_sandstone_slab_vertical|매끄러운 사암 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	...
	SMOOTH_RED_SANDSTONE_SLAB_VERTICAL(Material.SMOOTH_RED_SANDSTONE_SLAB, "&ikey:block.cucumbery.smooth_red_sandstone_slab_vertical|매끄러운 붉은 사암 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	CUT_RED_SANDSTONE_SLAB_VERTICAL(Material.CUT_RED_SANDSTONE_SLAB, "&ikey:block.cucumbery.cut_red_sandstone_slab_vertical|깎인 붉은 사암 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	...
	PRISMARINE_BRICK_SLAB_VERTICAL(Material.PRISMARINE_BRICK_SLAB, "&ikey:block.cucumbery.prismarine_brick_slab_vertical|프리즈머린 벽돌 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	DARK_PRISMARINE_SLAB_VERTICAL(Material.DARK_PRISMARINE_SLAB, "&ikey:block.cucumbery.dark_prismarine_slab_vertical|짙은 프리즈머린 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	...
	RED_NETHER_BRICK_SLAB_VERTICAL(Material.RED_NETHER_BRICK_SLAB, "&ikey:block.cucumbery.red_nether_brick_slab_vertical|붉은 네더 벽돌 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	...
	POLISHED_BLACKSTONE_SLAB_VERTICAL(Material.POLISHED_BLACKSTONE_SLAB, "&ikey:block.cucumbery.polished_blackstone_slab_vertical|윤나는 흑암 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	POLISHED_BLACKSTONE_BRICK_SLAB_VERTICAL(Material.POLISHED_BLACKSTONE_BRICK_SLAB,
			"&ikey:block.cucumbery.polished_blackstone_brick_slab_vertical|윤나는 흑암 벽돌 세로 반 블록", CreativeCategory.BUILDING_BLOCKS),
	END_STONE_BRICK_SLAB_VERTICAL(Material.END_STONE_BRICK_SLAB, "&ikey:block.cucumbery.end_stone_brick_slab_vertical|엔드 석재 벽돌 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	...
	SMOOTH_QUARTZ_SLAB_VERTICAL(Material.SMOOTH_QUARTZ_SLAB, "&ikey:block.cucumbery.smooth_quartz_slab_vertical|매끄러운 석영 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	...
	EXPOSED_CUT_COPPER_SLAB_VERTICAL(Material.EXPOSED_CUT_COPPER_SLAB, "&ikey:block.cucumbery.exposed_cut_copper_slab_vertical|약간 녹슨 깎인 구리 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	WEATHERED_CUT_COPPER_SLAB_VERTICAL(Material.WEATHERED_CUT_COPPER_SLAB, "&ikey:block.cucumbery.weathered_cut_copper_slab_vertical|녹슨 깎인 구리 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	OXIDIZED_CUT_COPPER_SLAB_VERTICAL(Material.OXIDIZED_CUT_COPPER_SLAB, "&ikey:block.cucumbery.oxidized_cut_copper_slab_vertical|산화된 깎인 구리 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	WAXED_CUT_COPPER_SLAB_VERTICAL(Material.WAXED_CUT_COPPER_SLAB, "&ikey:block.cucumbery.waxed_cut_copper_slab_vertical|밀랍칠한 깎인 구리 세로 반 블록",
			CreativeCategory.BUILDING_BLOCKS),
	WAXED_EXPOSED_CUT_COPPER_SLAB_VERTICAL(Material.WAXED_EXPOSED_CUT_COPPER_SLAB,
			"&ikey:block.cucumbery.waxed_exposed_cut_copper_slab_vertical|밀랍칠한 약간 녹슨 깎인 구리 세로 반 블록", CreativeCategory.BUILDING_BLOCKS),
