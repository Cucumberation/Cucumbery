...
public enum CustomMaterial implements Translatable
{
	...
	YOUPEOPLEGAME_CRISPY_COOKIE_AXE(Material.DIAMOND_AXE,
			ComponentUtil.translate("&6key:item.youpeoplegame.crispy_cookie_axe|바삭한 쿠키도끼").shadowColor(ShadowColor.shadowColor(-256)), Rarity.RARE, "바삭한 쿠키"),
	...
	YOUPEOPLEGAME_CRISPY_COOKIE_SHOVEL(Material.DIAMOND_SHOVEL,
			ComponentUtil.translate("&6key:item.youpeoplegame.crispy_cookie_shovel|바삭한 쿠키삽").shadowColor(ShadowColor.shadowColor(-256)), Rarity.RARE, "바삭한 쿠키"),
