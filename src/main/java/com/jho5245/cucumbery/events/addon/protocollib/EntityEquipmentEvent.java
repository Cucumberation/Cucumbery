...
public class EntityEquipmentEvent extends PlayerEvent implements Cancellable
{
	boolean cancel;
	private static final HandlerList handlers = new HandlerList();
	private ItemStack itemStack;

	public EntityEquipmentEvent(@NotNull Player player, @NotNull ItemStack itemStack)
	{
		super(player);
