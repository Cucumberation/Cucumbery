    ...
    if (entity instanceof TNTPrimed tntPrimed)
    {
      if (tntPrimed.getSource() == null)
      {
		...
		if (entity instanceof LivingEntity livingEntity)
		{
			...
			if (equipment != null)
			{
				ItemStack mainHand = equipment.getItemInMainHand(), offHand = equipment.getItemInOffHand(), helmet = equipment.getHelmet(), chestplate = equipment.getChestplate(), leggings = equipment.getLeggings(), boots = equipment.getBoots();
